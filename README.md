...
- SFU CMPT 310: Artificial Intelligence Survey, Individual Project: Tic Tac Toe Playing Program.
- This assignment to implement (in Python) a Tic-Tac-Toe playing program where a human can play against the computer, and the computer makes all its moves using random playouts as described below.
...
- To run tic_tac_toe.py, type the following in the terminal: `tic_tac_toe.py`.
