#The codes are inspired and modified from the website:https://github.com/Duo-Lu/CMPT310/blob/master/Assignment4/a4.py, and I would like to express my thanks to the author.
import math
import random

DEBUG = False

#First, to set up the chess board.
def display(state):
    i = 0
    print('-----------')
    for i in range(0,9):
...
#Set up pure Monte Carlo Tree Search
...
def play_a_new_game():
    print("Welcome To Tic-Tac-Toe Game AI")
    print("If You Want To Play First in \"O\", Press 1, Otherwise in \"X\", Press 2 ")
    ...
    while user_decision != 1 and user_decision != 2:
        print("Error , Please Enter The Correct Number(1 or 2)! : " , end = '')
    ...
    if user_decision == 1:
        for i in range(5):
            ...
            player_decision = input("Player Enter The Step: ")
            ...
            while player_decision > 9 or player_decision < 1:
                ...
                player_decision = int(input("Player Enter The Step: "))     
            if chess[player_decision - 1] != 0:
                print("Error , \"O\" Has Already On The Board ")
        ...
        for i in range(5):
            ...
            if chess[player_decision - 1] != 0:
                print("Error , \"X\" Has Already On The Board ")
            while chess[player_decision - 1] != 0:
                print("Re-enter Your Decision: ")
                player_decision = int(input("Player Enter The Step: "))
